...
const PlantDesc = ({ route }) => {
  ...
  const [status, setStatus] = useState() // optional: biar user bisa tau aja skrng di code nya lg jalan apa (ex: load model, process image, predicting, etc)
  ...
  // pas aku cek, ga semua nama ini tersedia di wikipedia, kalau kalian mau adjust nama classnya manual juga harusnya gpp, nyesuaiin kalian aja
  const classNames = {
    1: 'common guava',
    2: 'ivy tree',
    3: 'garden geranium',
  ...
  useEffect(() => {
    ...
    const loadModelAndPredict = async () => {
      try {
        ...
        /*
           jadi kalo aku liat, atau kalau kalian mau cba jalanin n console.log, bakal keliatan kalau dia returnnya itu
           berupa array. terus aku nangkep logicnya itu jadi dia bakal ngereturn 100 angka berupa array.
           terus tar kita liat dari 100 itu angka apa yang paling banyak muncul.
           angka yang muncul ini range 1-7.
           jadi aku simpulin angka yang paling banyak muncul berarti dia detectnya itu classnya, gitu.
           kalian juga bisa adjust ya misal nemu logic lain
        */
  ...
  // NOTE
  // pas aku cek dengan nama plant yang beda", aku blm ada nemu yg order, family, sma genusnya bisa muncul
  // mungkin kalian juga bisa adjust aja apa mau diilangin aja atau cari cara lain buat nampilin ketiga info itu
  // atau kalau ternyata memang bisa jg gpp
    ...
    <View style={styles.container}>
      ...
      <View style={styles.whiteBackground}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          {/* NEW : ini aku tambahin buat nampilin tampilan kalau datanya masih processing sama kalau udah kelar.
